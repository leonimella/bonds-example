...
contract ERC3475 is IERC3475 {
  ...
  function transferFrom(
    ...
    require(
      msg.sender == _from || isApprovedFor(_from, msg.sender),
  ...
  function nonceValues(
    ...
    uint256 nonceId,
    uint256 metadataId
  ) external view override returns (Values memory) {
  ...
  /**
     ...
     */
  function isApprovedFor(address _owner, address operator)
    public
    view
    virtual
    override
  ...
  function _transferFrom(
    ...
    Nonce storage nonce = _classes[_transaction.classId].nonces[
      _transaction.nonceId
    ];
    require(
  ...
  function _issue(address _to, IERC3475.Transaction calldata _transaction)
    private
  {
    Nonce storage nonce = _classes[_transaction.classId].nonces[
      _transaction.nonceId
